...
{    
       ...
       if(status > 0 ){
            printk("[BAT][Chg][smb346] write enable\r\n");
       }
}
...
bool smb346_IsFull(void)
{
    ...
    {	
        printk("[BAT][smb346]:IsFull:true\n");
    	return true;
    }else{
        printk("[BAT][smb346]:IsFull:false\n");
    	return false;
    }
}
//Eason judge smb346 full ---
...
static bool AXC_Smb346_Charger_IsCharging(AXI_Charger *apCharger)
{
    ...
    {
    	printk("[BAT][smb346]:Pre charging\n");
    	return true;
    }else if(4==FastChargingStatus){
    	printk("[BAT][smb346]:Fast charging\n");
    	return true;
    }else if(6==TaperChargingStatus){
    	printk("[BAT][smb346]:Taper charging\n");
    	return true;
    }else{
    	return false;
    }
