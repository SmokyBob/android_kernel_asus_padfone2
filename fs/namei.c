...
//ASUS_BSP +++ Jimmy,Josh "remove fuse"
		if(strcmp(nd->path.mnt->mnt_mountpoint->d_iname,"sdcard")==0){
			mode = 0664;
		}
//ASUS_BSP --- Jimmy,Josh "remove fuse"
		/*
...
//ASUS_BSP +++ Jimmy,Josh "remove fuse"
	if(strcmp(nd.path.mnt->mnt_mountpoint->d_iname,"sdcard")==0){
		...
		error = vfs_mkdir(nd.path.dentry->d_inode, dentry, 0775);
		if (!error) {
			newattrs.ia_valid = ATTR_GID;
			newattrs.ia_gid = 1015;//set to sdcard_rw for sdcard
